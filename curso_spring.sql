...
INSERT INTO `categoria` VALUES (1,'Informatica'),(2,'Escritorio'),(3,'Casa mesa y baño'),(4,'Electronicos'),(5,'Jardineria'),(6,'Decoracion'),(7,'Perfumeria');
...
INSERT INTO `endereco` VALUES (1,'Jardin','3820834','Apt 303','Rua Flores','300',1,1),(2,'Centro','38777012','Salas 800','Avenida Matos','105',2,1);
...
INSERT INTO `estado` VALUES (1,'Mina gerais'),(2,'Sao Paulo');
...
INSERT INTO `pagamento_com_boleto` VALUES (NULL,'2020-10-20 00:00:00.000000',2);
...
INSERT INTO `pedido` VALUES (1,'2020-01-11 19:21:00.000000',1,1),(2,'2020-01-11 19:25:00.000000',1,2);
...
INSERT INTO `produto` VALUES (1,'Computador',2000),(2,'Impresora',800),(3,'Mouse',80),(4,'Mesa de Escritorio',300),(5,'Toalla',50),(6,'Colcha',200),(7,'Tv a color',1200),(8,'Manguera',800),(9,'Lampara',100),(10,'Pendiente',180),(11,'Shampo',90);
/*!40000 ALTER TABLE `produto` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `produto__categoria`
--

DROP TABLE IF EXISTS `produto__categoria`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `produto__categoria` (
  `produto_id` int(11) NOT NULL,
  `categoria_id` int(11) NOT NULL,
  KEY `FKguqt9djgod6764rvsdr5dmko` (`categoria_id`),
  KEY `FKtfnwaewm43e5hi2lbxs9938gy` (`produto_id`),
  CONSTRAINT `FKguqt9djgod6764rvsdr5dmko` FOREIGN KEY (`categoria_id`) REFERENCES `categoria` (`id`),
  CONSTRAINT `FKtfnwaewm43e5hi2lbxs9938gy` FOREIGN KEY (`produto_id`) REFERENCES `produto` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `produto__categoria`
--

LOCK TABLES `produto__categoria` WRITE;
/*!40000 ALTER TABLE `produto__categoria` DISABLE KEYS */;
INSERT INTO `produto__categoria` VALUES (1,1),(1,4),(2,1),(2,2),(2,4),(3,1),(3,4),(4,2),(5,3),(6,3),(7,4),(8,5),(9,6),(10,6),(11,7);
/*!40000 ALTER TABLE `produto__categoria` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `telefone` VALUES (1,'984123456'),(1,'994000944');
...
-- Dump completed on 2020-02-14 16:25:10
