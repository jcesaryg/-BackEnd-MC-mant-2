...
public class CategoriaService {
	...
	public Categoria find(Integer id) {
		...
		return obj.orElseThrow(() -> new ObjectNotFoundException(
				"Objeto no Encontrado Id: " + id + ",Tipo: " + Categoria.class.getPackageName()));
	}
	...
	public Categoria update(Categoria obj) {
		Categoria newObj = find(obj.getId()); // se llamara find por que buscara si existen los registros o sino pasara
												// algun error
