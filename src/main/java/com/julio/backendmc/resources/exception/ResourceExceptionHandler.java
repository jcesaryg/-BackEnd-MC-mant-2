...
public class ResourceExceptionHandler {
	...
	{
		StandardError err = new StandardError(HttpStatus.BAD_REQUEST.value(), e.getMessage(), System.currentTimeMillis());//Se instancia el estandar error
		return ResponseEntity.status(HttpStatus.NOT_FOUND).body(err);
	}
	...
	public ResponseEntity<StandardError> validation(MethodArgumentNotValidException e,HttpServletRequest request)
	{
		...
		ValidationError err = new ValidationError(HttpStatus.BAD_REQUEST.value(), "Error de Validacion", System.currentTimeMillis());//Se instancia el estandar error
