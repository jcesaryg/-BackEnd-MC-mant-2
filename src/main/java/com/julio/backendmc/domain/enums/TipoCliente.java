...
public enum TipoCliente {
	...
	// guardar con nombre de persona fisica o juridica en la base de datos no es lo
	// recomendable por que ocupa mucho espacio por lo que
	// se recomienda utilizar codigos. para poder almacenarlos.

	// Para la asignacion de datos se coloca el valor del codigo numero de persona
	// fisica y el de persona juridica
	PESSOAFISICA(1, "Persona Fisica"), PESSOAJURIDICA(2, "Persona Juridica");
